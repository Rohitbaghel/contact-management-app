    ...
    <div className="max-w-4xl mx-auto p-4">
      ...
      <ul className="space-y-4">
        {contacts.map((contact: Contact) => (
          <li key={contact.id} className="bg-white shadow-md rounded px-8 py-6">
            <div>
              ...
              <div className="flex space-x-2 mt-4">
                ...
                <button onClick={() => handleDeleteContact(contact.id)} className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-200">Delete</button>
              </div>
            </div>
          </li>
        ))}
